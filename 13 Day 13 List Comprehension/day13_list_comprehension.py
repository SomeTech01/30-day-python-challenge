...
print(list) create a list that squares the list content

list =[expression for item in iterable if conditions]
list = [i  for item in list if i >= 60] ## list everything 

list =[expression if i conditions else for item in iterable ]
list = [i if i >= 60 else 'FAILED' for item in list ] 
'''
